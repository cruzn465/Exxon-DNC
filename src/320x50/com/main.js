...
function animate(){
    ...
    .staggerFrom([c1_2x,c2_2x,c3_2x,c4_2x],.5,{opacity:0,y:30,ease:Power1.easeOut},.25,.6)
    .from(c5_2x,.5,{opacity:0,y:-20,ease:Power1.easeOut},2.4)
    ...
    // }},.05,3)
    .staggerFrom(cta,.3,{opacity:0,x:30,ease:Power1.easeOut},.05,3.3)
    .fromTo(ctaArr_2x, .5, {x:0,ease:Power2.easeInOut}, {x:6,ease:Power2.easeInOut})
